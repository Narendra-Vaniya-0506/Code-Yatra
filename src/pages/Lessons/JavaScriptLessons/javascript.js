...
export default function JavaScriptLessons() {
  ...
  const sidebar = (
    <nav className="lesson-sidebar-nav">
      ...
      <div className="lesson-section">
        ...
        >
          <li><a href="#overview" onClick={() => handleLinkClick("overview")} className={activeLink === "overview" ? "active": ""}>javascript Overview</a></li>
  ...
  return (
    <LessonLayout
      ...
      sidebar={sidebar}
      lessonId="javascript-introduction"
    >
      {/* Hero Section */}
      <div className="lesson-hero">
        <h1>JavaScript Tutorial</h1>
        <p>JavaScript is a programming language used primarily for web development.</p>
      </div>

      {/* Main Content */}
      <div id="overview">
        <h2>Get Started</h2>
        <p>Welcome to the JavaScript Tutorial series! To begin learning:</p>
        <ol>
      ...
      <div id="installation" style={{ paddingTop: '60px', marginTop: '-60px' }}>
        <h2>Installation</h2>
        <p>Content about using JavaScript goes here...</p>
      </div>

      <div id="syntax" style={{ paddingTop: '60px', marginTop: '-60px' }}>
        <h2>Syntax</h2>
        <p>Content about JavaScript syntax goes here...</p>
      </div>
